...
err = h;
F = @(x,y,element_index,dx,dy)(real_u(x,y,t0,dx,dy) - get_element_local_basis_pvalue(uh, x, y, element_index, Nb, P, T, Tb, dim, type, dx, dy)) .^2;
G = @(x,y,element_index)max(abs(real_u(x,y,t0,0,0) - get_element_local_basis_pvalue(uh, x, y, element_index, Nb, P, T, Tb, dim, type, 0, 0)));
