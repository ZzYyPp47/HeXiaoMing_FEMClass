...
[U,uh_end] = t_fdm(iteration_num, tol, M, A, b_all, Time, u0, option, P, T, Pb_u, Pb_p, Tb_u, Nf_u, Nf_p, Nm, B_f_edges_u, B_m_edges, Nb_u, @func_boundary1, @func_boundary2, @func_real_p, [], [], [], [], [dim_u type_u]);
