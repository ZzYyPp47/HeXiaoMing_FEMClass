...
b = [b1;b2;O2];
%% 使用边界条件信息矩阵调整边界条件
[A,b] = boundary_adjust(A,b,P,T,Pb_u,Tb_u,B_f_edges_u,B_m_edges,Nf_u,Nb_u,Nb_u,@func_boundary1,@func_boundary2,[],[],[],[],dim_u,type_u);% 调用调整器
[A,b] = fixed_presure(A,b,@func_real_p,Nf_u + Nf_u,1,Pb_p);
