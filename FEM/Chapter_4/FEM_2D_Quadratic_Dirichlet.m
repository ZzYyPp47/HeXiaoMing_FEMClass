...
function [U,err] = FEM_2D_Quadratic_Dirichlet(input_h,option,fig_flag,err_flag,err_types)
%% 输入网格信息
left = 0;
right = 2;
down = 0;
...
err = [];
if fig_flag == true
    show_eval(option, @func_real_u, U, f_X, f_Y, Time, "Quadratic 2D FEM")% 调用可视化
end
if err_flag == true
