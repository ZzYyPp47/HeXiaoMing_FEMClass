...
function [U, uh_end] = t_fdm(M, A, b_all, theta, Time, u0, option, P, T, Pb, Tb, B_f_edges, B_m_edges, Nb_test, Nb_trial, func_boundary, func_c, func_p, func_q, func_r, dim, type)
%% Modify to meet your needs
    ...
    for iteration = 1:length(Time) - 1
        ...
        [left_hand, right_hand] = boundary_adjust(left_hand, right_hand, P, T, Pb, Tb, B_f_edges, B_m_edges, Nb_test, Nb_trial, func_boundary, func_c, func_p, func_q, func_r, dim, type, Time(iteration + 1));% 调用边界调整器
